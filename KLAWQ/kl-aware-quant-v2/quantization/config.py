...
class QuantizeConfig():
    ...
    #NEW SHITTTTTTTTTTTTTTTTTTT
    beta: float = field(default=0.0, metadata={"help": "Weight for KL divergence Hessian term."})
    gamma: float = field(default=0.0, metadata={"help": "Weight for Cross-Entropy Hessian term (optional)."})
    tau: float = field(default=1.0, metadata={"help": "Temperature for softmax in KL/CE calculations."})
